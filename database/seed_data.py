        ...
        services_data = [
            {
                ...
                "short_desc": "Crafting iconic brand stories, naming, visual identity systems, and tone of voice that resonate and endure.",
                "full_desc": "We build brands that people fall in love with. From market discovery and competitor auditing to comprehensive brand guideline books, logotypes, color palettes, and typographic hierarchies.",
                "icon": "sparkles",
                "display_order": 1,
                "is_active": 1,
            },
            {
                ...
                "short_desc": "High-performance digital products, responsive web development, and immersive UI/UX experiences designed to convert.",
                "full_desc": "Your digital flagship must do more than look gorgeous—it must perform flawlessly. We design and develop lightning-fast websites with fluid interactions and conversion architecture.",
                "icon": "layout",
                "display_order": 2,
                "is_active": 1,
            },
            {
                "title": "Commercial Photography & Visuals",
                "slug": "photography-visual-craft",
                "short_desc": "Commercial photography, product shoots, and editorial storytelling tailored for omnichannel brand impact.",
                "full_desc": "Bespoke studio and on-location art direction, food & beverage photography, lifestyle campaigns, and architectural documentation that elevate your brand equity.",
                "icon": "camera",
                "display_order": 3,
                "is_active": 1,
            },
            {
                ...
                "slug": "local-seo-performance-marketing",
                "short_desc": "Data-backed search optimization, local map visibility, and growth campaigns that drive high-intent qualified leads.",
                "full_desc": "Dominating top spots in local search queries and map packs across Bengaluru and beyond, turning searchers into booked clients and repeat customers.",
                "icon": "trending-up",
                "display_order": 4,
                "is_active": 1,
            },
